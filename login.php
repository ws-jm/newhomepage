...
<html lang="en">
	...
	<meta property="og:title" content="Credit Panel Login" />
	<meta property="og:url" content="https://creditpanel.in/login.php" />
	<meta property="og:site_name" content="Credit Panel Bulk Whatsapp Broadcast" />
    <title>Login | Credit Panel | Bulk Whatsapp Broadcast</title>
						...
						<div class="d-flex flex-center p-15 shadow bg-body rounded w-100 w-md-550px mx-auto ms-xl-20">
							...
							<form class="form" onsubmit="return validateForm()" name="myForm" id="loginform" action="process_login.php" method="post">
								...
								<div class="mb-10 text-center">
									<!--begin::Title-->
									<h1 class="text-dark mb-3">Login Now</h1>
									<!--end::Title-->
									<!--begin::Link-->
									<div class="text-gray-400 fw-bold fs-4">Don't yet Registered!
									<a href="signup.php" class="link-primary fw-bolder">Sign Up Now</a></div>
									<!--end::Link-->									
								</div>
