...
if (isset($_POST['submit'])) {
    ...
    if ($credit != 0 || !empty($credit)) {
        ...
        if (empty($_SESSION['error'])) {
           ...
           $header = trim($_POST['headermsg']);
           $header_message = filter_var($header, FILTER_SANITIZE_STRING, FILTER_FLAG_ENCODE_LOW);
           $footer = trim($_POST['footermsg']);
            $footer_message = filter_var($footer, FILTER_SANITIZE_STRING, FILTER_FLAG_ENCODE_LOW);
            ...
            $link = (isset($_POST['linkbtn']) ? $_POST['linkbtn'] : "");
            $phone = (isset($_POST['callbtn']) ? $_POST['callbtn'] : "");
                ...
                if($mob <=10)
                {
                    ...
                    foreach(explode(",",$nums) as $tempnum){
                            ...
                            curl_setopt_array($curl, [
                                ...
                                CURLOPT_POSTFIELDS => "{\"phone\":\"+$tempnum\",\"message\":\"$msg\",\"header\":\"$header_message\",\"footer\":\"$footer_message\",\"buttons\":[{\"id\":\"id1\",\"kind\":\"call\",\"text\":\"Call Now\",\"value\":\"$phone\"},{\"id\":\"id2\",\"kind\":\"url\",\"text\":\"Visit Now\",\"value\":\"$link\"}]}",
                                CURLOPT_HTTPHEADER => [
                                    "Content-Type: application/json",
                                    "Token: 5977ad93c8c7fe432f3173763eafdbf0bc8823e8d59f87aa84147097bce47cb974d707823fc04400"
                            ],
                            ]);
                    ...
                    if($flag == true){
                        ...
                        $stmt->bind_param("isssissssssssssssssss", $login_id, $camp_unique_id, $caption, nl2br($_POST['description']), $number_count, $pimagename1, $pimagename2, $pimagename3, $pimagename4, $pdf_f, $audio_f, $video_f, $dp_image, $rplybtn1, $rplybtn2, $phone, $link, $status, $created_date,$created_date, $sort_date);
                        if ($stmt->execute()) {
                        ...
                        $_SESSION['error'] = "Send Message Error.";
                        header("Location: sendwhatsapp.php");
                        exit();
                    }
