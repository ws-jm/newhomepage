                        ...
                        <div class="row" style="margin:3%">
                            <div class="card card-flush">
                                <div class="white-box" style="padding:3%">
                                    ...
                                    <h2 class="text-primary">PDF Message
                                    ...
                                    <input type="hidden" name="login_id" value="<?php echo $_SESSION['login_id']; ?>">
                                     <!-- Phone Number -->
                                            ...
                                            <label for="pdf_file" id="pdf_file" class="required fs-5 fw-bold mb-2">Upload PDF</label>
                                            <input type="file" id="pdf_file"  name="pdf_file" class="form-control form-control-solid"
                                                       accept="image/pdf">
