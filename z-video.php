                        ...
                        <div class="row" style="margin:3%">
                            <div class="card card-flush">
                                <div class="white-box" style="padding:3%">
                                    ...
                                    <h2 class="text-primary">VIDEO Message
                                    ...
                                    <input type="hidden" name="login_id" value="<?php echo $_SESSION['login_id']; ?>">
                                     <!-- Phone Number -->
                                        ...
                                        <div class="custom-file">
                                            <label for="video_file" id="video_file" class="required fs-5 fw-bold mb-2">Upload VIDEO</label>
                                            <input type="file" id="video_file" name="video_file" class="form-control form-control-solid"
