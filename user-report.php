...
<html lang="en">
    ...
    <title>User Report | Credit Panel | Bulk Whatsapp Broadcast</title>
                ...
                <div class="white-box">
                    ...
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder fs-3 mb-2">User Report</span>
                            <span class="text-dark fw-bold fw-bolder fs-4 mt-1 text-muted bg-light">LIST OF ALL USER CREDIT REPORT</span>
                                            ...
                                            <?php include_once 'db_config.php';
                                                ...
                                                if($_SESSION['login_type'] == 'user'){
                                                        $sql = "SELECT
                                                            ...
                                                            WHERE lg.user_type = 'user'  and transaction_logs.login_user_unique_id = ? or transaction_logs.user_unique_id = ? order by transaction_logs.id desc";
                                                ...
                                                if ($stmt->execute()) {
                                                    $stmt->bind_result($txn_in, $user_name, $reseller_unique_id, $no_of_sms, $per_sms_price, $old_credit, $tax_status, $tax_percentage, $total_amount, $tax_amount, $tax_type, $description, $user_type, $login_username, $login_user_type, $created_at);
                                                    $inc = 1;
                                                    while ($stmt->fetch()) { ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center"><span class="badge badge-light-primary fs-7 fw-bold"
                                                            ...
                                                            <td class="text-center"><?php echo ($tax_status == "Yes") ? "<span class='badge badge-light-success fs-7 fw-bold' >Yes</span>" : "<span class='badge badge-light-danger fs-7 fw-bold'>No</span>" ?></td>
                                                            ...
                                                            <td class="text-center"><?php echo ($tax_type == "credit") ? "<span class='badge badge-light-info fs-7 fw-bold' >Credit</span>" : "<span class='badge badge-light-warning fs-7 fw-bold'>Debit</span>"
                                                                ?></td>
