...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title m-b-0">Post New Job</h3>
                    <br>
                    <form class="form" method="post" action="process-job.php" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box" id="imge-popups">
                    <h3 class="box-title m-b-0" id="fame">LIST OF all Post Jobs</h3>
                    <div class="table-responsive">
                        <table id="myTable" class="table table-striped">
                            ...
                            $sql="SELECT `id`, `title`, `description`, `created_at` FROM `post_job`";
                            ...
                            if($stmt->execute()){
                                ...
                                while ($stmt->fetch()){ ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href='job-post-edit.php?edit_id=<?php echo $id; ?>' class='btn btn-circle btn-success btn-sm' title='edit'><i class='fa fa-pencil'></i></a>
                                            <a title="Delete Entry" href="delete-post.php?id=<?php echo $id; ?>" class="btn btn-danger btn-circle" onclick="if(!confirm('Are you sure to delete this entry?')){return false;}"><i class="fa fa-trash"></i> </a></td>
                                    </tr>
                                    <?php $inc++; }
                            }
                            else{
