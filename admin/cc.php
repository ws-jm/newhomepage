...
<script type="text/javascript">
        var token = '<?php _e( $this->security->get_csrf_hash() )?>',
            ...
            function sendotp() {
                ...
                theUrl= 'https://waziper.in/api/send.php?number='+phone_number+'&type=text&message=Your otp code is '+otp+'&instance_id=633EDB5B935FC&access_token=e9e72818f56b9b56bd2a5ffa0606dec5';
                //https://zumyoda.com/api/send.php?number=+923338774213&type=text&message=test%20message&instance_id=630DE1E0ADBCE&access_token=e7e7771262d57b3885bb9a87b4a52af1
