                ...
                <div class="white-box" style="padding:3%">
                    ...
                    <div class="form-group row">
                        <?php if (!empty($photo1)) { ?>
                            ...
                            <div class="col-lg-2">
                                <a href="img/upload/<?php echo $photo1; ?>"
                                   class="img-thumbnail waves-effect waves-light zoom-mp-img">
                                    <img src="img/upload/<?php echo $photo1; ?>"
                                         style="width:50px; height:50px;">
                                </a>
                                <br/>
                                <a href="img/upload/<?php echo $photo1; ?>" class="btn btn-outline-primary"
                        ...
                        <?php if (!empty($photo2)) { ?>
                            ...
                            <div class="col-lg-2">
                                <a href="img/upload/<?php echo $photo2; ?>"
                                   class="img-thumbnail waves-effect waves-light zoom-mp-img">
                                    <img src="img/upload/<?php echo $photo2; ?>"
                                         style="width:50px; height:50px;">
                                </a>
                                <br/>
                                <a href="img/upload/<?php echo $photo2; ?>" title="Download"
                        ...
                        <?php if (!empty($photo3)) { ?>
                            ...
                            <div class="col-lg-2">
                                <a href="img/upload/<?php echo $photo3; ?>"
                                   class="img-thumbnail waves-effect waves-light zoom-mp-img">
                                    <img src="img/upload/<?php echo $photo3; ?>"
                                         style="width:50px; height:50px;">
                                </a>
                                <br/>
                                <a href="img/upload/<?php echo $photo3; ?>" title="Download"
                                   class="btn btn-outline-primary" download><i class="fa fa-download"></i>
                                    Download</a>
                            </div>
                        <?php } ?>
                        <?php if (!empty($photo4)) { ?>
                            ...
                            <div class="col-lg-2">
                                <a href="img/upload/<?php echo $photo4; ?>"
                                   class="img-thumbnail waves-effect waves-light zoom-mp-img">
                                    <img src="img/upload/<?php echo $photo4; ?>"
                                         style="width:50px; height:50px;">
                                </a>
                                <br/>
                                <a href="img/upload/<?php echo $photo4; ?>" title="Download"
                                   class="btn btn-outline-primary" download><i class="fa fa-download"></i>
                                    Download</a>
                            </div>
                        <?php } ?>
                    ...
                    <div class="form-group row">
                        <?php if (!empty($up_pdf)) { ?>
                            ...
                            <div class="col-lg-2"><a href="img/upload/pdf/<?php echo $up_pdf; ?>"
                        ...
                        <?php if (!empty($audio)) { ?>
                            ...
                            <div class="col-lg-2"><a href="img/upload/audio/<?php echo $audio; ?>"
                        ...
                        <?php if (!empty($video)) { ?>
                            ...
                            <div class="col-lg-2"><a href="img/upload/video/<?php echo $video; ?>"
                                                     title="Download"
                    ...
                    <div class="form-group row">
                        ...
                        <?php if (!empty($dp_image)) { ?>
                            ...
                            <div class="col-lg-2">
                                <a href="img/upload/<?php echo $dp_image; ?>"
                                   class="img-thumbnail waves-effect waves-light zoom-mp-img">
                                    <img src="img/upload/<?php echo $dp_image; ?>"
                                         style="width:50px; height:50px;">
                                </a>
                                <br/>
                                <a href="img/upload/<?php echo $dp_image; ?>" title="Download"
                                   class="btn btn-outline-primary" download><i class="fa fa-download"></i>
                                    Download</a>
                            </div>
                        <?php } ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10"> <span class="badge badge-light-success"><?php echo $created_by; ?></span></div>
                        ...
                        <div class="col-lg-10"><span class="badge badge-light-success"><?php echo $created_user_type; ?></span></div>
                    </div>
                    <hr>
                    <div class="form-group row">
