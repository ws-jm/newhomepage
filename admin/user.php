...
<html lang="en">
    ...
    <title>Add User | Credit Panel | Bulk Whatsapp Broadcast</title>
                ...
                <?php if (isset($_GET['action'])) {
                        ...
                        <div class="row">
                            <div class="card card-flush">
                                <div class="white-box" style="padding:3%">
                                    <h3 class="box-title m-b-0" style="margin-bottom:3%" style="margin-bottom:3%">Add New User</h3>
                                    ...
                                    <form class="form" method="post" action="process-add-user.php"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-4 mb-5">
                                                <select name="status" id="" data-control="select2" class="form-select form-select-solid fw-semibold" data-hide-search="true">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-12">
                                                ...
                                                <a href="user.php" style="margin-left:1%"
                    ...
                    <?php } elseif (($_GET['action']) == 'view' && ($_GET['unique_id'])) {
                        ...
                        <div class="row">
                            <div class="card card-flush">          
                                <div class="white-box" style="padding:3%">
                                <div class="col-sm-12"><a href="user.php" style="float:right !important;"
                                    class="btn btn-primary pulse pulse-white">Back</a></div> 
                                    <h3 style="margin-top:3%" class="box-title text-primary pulse pulse-white ">View User Details
                                    </h3>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4 mb-5 fs-5">
                                            ...
                                            <?php } else { ?>
                                                <strong class="box-title text-danger pulse pulse-white">Inactive</strong>
                                            <?php }
                                            ?>
                                        </div>
                                    </div>
                    ...
                    <?php } elseif (($_GET['action']) == 'edit' && ($_GET['unique_id']) && ($_GET['rollback'])) {
                        ...
                        <div class="row">
                                <div class="card card-flush">
                                <div class="white-box" style="padding:3%">
                                    <h3 class="box-title m-b-0" style="margin-bottom:3%">Edit user Details</h3>
                                    ...
                                    <form class="form" method="post" action="process-edit-user.php"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-4 mb-5">
                                                <input class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" type="text" placeholder="Mobile"
                                                       name="usr_mobile"
                                                       id="usr_mobile" value="<?php echo $u_mobile; ?>" >
                                            </div>
                                            <div class="col-lg-1"></div>
                                            <label for="title" class="col-lg-me col-form-label text-dark text-hover-primary fs-5 fw-bolder">Company </label>
                                            <div class="col-lg-4 mb-5">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="white-box" id="imge-popups">
                                    ...
                                    <h3 class="box-title m-b-0" style="margin-bottom:3%" id="fame">List Of All User</h3>
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="card">
                                                <div class="card-body table-responsive">
                                                <div class="col-md-12"><a href="user.php?action=add" style="margin-left:2%;margin-top:1%;float:right"
                                                            class="btn btn-primary pulse pulse-white">Add New user</a></div>
                                                    ...
                                                    <table id="selection-datatable" class="table table-bordered nowrap">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <?php include_once 'db_config.php';
                                                                ...
                                                                $reseller_rollback = "disabled";
                                                                $conn = new mysqli($servername, $username, $password, $dbname);
                                                                if ($conn->connect_error) {
                                                                    die("Connection failed: " . $conn->connect_error);
                                                                }
                                                                $sql = "SELECT `id`, `user_type`, `user_unique_id`, `full_name` ,`username`, `email_id`, `mobile`, `credit`,`status` FROM `logins` WHERE `user_type`= 'user' and parent_id = '$parent_id'  order by id desc";
                                                                    ...
                                                                    while ($stmt->fetch()) { ?>
                                                                        <tr>
                                                                            ...
                                                                            <td class="text-center">
                                                                                ...
                                                                                <a href='user.php?action=view&unique_id=<?php echo $unique_id; ?>' title='View Details'   class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
                                                                                    <span class="svg-icon svg-icon-3">
                                                                                        <i class='fa fa-eye'></i>
                                                                                    </span>
                                                                                </a>

                                                                                <a href='user.php?action=edit&unique_id=<?php echo $unique_id; ?>&rollback=<?php echo $reseller_rollback; ?>' title='Edit Details'   class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
                                                                                    <span class="svg-icon svg-icon-3">
                                                                                ...
                                                                                <a href='user.php?action=credit&unique_id=<?php echo $unique_id; ?>'  title='Fill Credit'  class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
                                                                                    <span class="svg-icon svg-icon-3">
                                                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                                                ...
                                                                                <a href="user.php?action=debit&unique_id=<?php echo $unique_id; ?>"  title="Remove Credit"  class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
                                                                                    <span class="svg-icon svg-icon-3">
                                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
