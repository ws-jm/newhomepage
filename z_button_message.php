...
<html lang="en">
    ...
    <title>Send Button Message | Credit Panel | Bulk Whatsapp Broadcast</title>
	...
	<?php include 'header.php'?>
                        ...
                        <div class="alert alert-danger align-items-center">
                            <!-- <span class="svg-icon svg-icon-2hx svg-icon-danger me-3">...</span> -->
                                ...
                                <h4 class="mb-1 text-dark"><marquee style="width : 90% !important;">Interactive Button Message will not work on iPhone.</marquee></h4>
                                <!-- <span>You can See you Campaign in Campaign Report Section</span> -->
                        ...
                        <div class="row" style="margin:3%">
                            <div class="card card-flush">
                                <div class="white-box" style="padding:3%">
                                    ...
                                    <h2 class="text-primary">Interactive Button Message
                                            ...
                                            <form class="form" method="post" action="w_buttonmessage.php" enctype="multipart/form-data">
                                            ...
                                            <!-- Phone Number -->
                                                    <div class="d-flex flex-column mb-10 fv-row">
                                                        ...
                                                        <textarea onKeyUp="countline()" type="text" class="form-control form-control-solid" cols="10" rows="5" id="mobileno1" name="mobileno" placeholder="Please Add 91 before Mobile No."></textarea>
                                                    </div>
                                                    <!-- Number Count -->
                                                    <div class="d-flex flex-column mb-10 fv-row">
                                                        <label for="userName" class="required fs-5 fw-bold mb-2">Number Count</label>
                                                        <input type="text" class="form-control form-control-solid" readonly id="numbercount1" required
                                                                name="numbercount" value="">
                                                    </div>

                                                    <div id = "" class="flex-column mb-10 fv-row">
                                                    <label for="video" id="video_f" class="required fs-5 fw-bold mb-2"> Header Message
                                                        </label>
                                                        <div class="d-flex flex-column mb-10 fv-row" id="video_file">
                                                            <input type="text" id="headermsg"  name="headermsg" class="form-control form-control-solid" placeholder="Enter button text">
                                                        </div>
                                                    </div>
                                                    <!-- Message -->
                                                    <div id = "" class="flex-column mb-10 fv-row">
                                                        <label for="exampleFormControlTextarea1" class="required fs-5 fw-bold mb-2">Body Message</label>
                                                    ...
                                                    <div id = "" class="flex-column mb-10 fv-row">
                                                        ...
                                                        <div class="d-flex flex-column mb-10 fv-row" id="video_file">
                                                            <input type="text" id="linkbtn"  name="linkbtn" class="form-control form-control-solid" placeholder="https://example.com">
                                                        </div>
                                                        
                                                        <label for="photo" class="required fs-5 fw-bold mb-2"> Call Button
                                                        </label>
                                                        <div class="d-flex flex-column mb-10 fv-row">
                                                            <input type="text" id="callbtn"  name="callbtn" class="form-control form-control-solid" placeholder="+919XXXXXXX99">
                                                        </div>
                                                        <label for="photo" class="required fs-5 fw-bold mb-2">Footer Message
                                                        </label>
                                                        <div class="d-flex flex-column mb-10 fv-row">
                                                            <input type="text" id="footermsg"  name="footermsg" class="form-control form-control-solid" placeholder="@Company Name">
                                                        </div>
                                                    </div>
                        ...
                        <script>
                        function countline() {
                        var length = $('#mobileno1').val().split("\n").length;
                        document.getElementById("numbercount1").value = length;
                        }    
                        </script>
